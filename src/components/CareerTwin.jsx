...
import { Target, Send, MessageSquare, Award, BookOpen, AlertTriangle } from 'lucide-react';
import { CAREER_PATHS, getAIAdvisorResponse } from '../data/mockData';
...
export default function CareerTwin({ 
  ...
  const handleSendMessage = (e) => {
    ...
    setTimeout(() => {
      const completedStepsCount = careerData.roadmap.filter(s => s.status === 'completed').length;
    ...
    <div className="career-twin-container">
      ...
      <div className="advisor-sidebar">
        ...
        <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineStyle: 'italic', lineHeight: 1.4 }}>
